...
public class UserCadWindow extends JFrame {
        ...
        buttonMap.get("btnCadastrar").addActionListener(e    -> {
            ...
            try {
                ...
                if (data.toString().split(",").length == txtFieldsValues.size()) {
                    ...
                    data.append("\n");
                    CsvWriter.writeCsvData(data.toString(), "./src/data/userData.csv");
                }
    ...
    // 3 Construtor
    public UserCadWindow(MainPane mainPane) {
...
//        this.setTitle("Cadastro de Usuários");
        ...
        this.add(labelMap.get("lblTitulo"));
    }
